...
var Tab = /** @class */ (function (_super) {
    ...
    Tab.prototype.removeActiveClass = function () {
        ...
        if (tabHeader) {
            ...
            tabItems.forEach(function (node) { return node.classList.remove(CLS_ACTIVE); });
        }
    };
    ...
    Tab.prototype.getTabHeader = function () {
        return [].slice.call(this.element.children).filter(function (e) { return e.classList.contains(CLS_HEADER); })[0];
    };
